    ...
    <body>
        ...
        <form class="shadow-box-square col-m-8 col-l-4 col-m-center" action="traitement.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input class="input" id="bdd-name" name="bdd-name" type="text" required>
            </div>
            <div class="form-group">
                <label class="control-label" for="bdd-user-name">Nom d'utilisateur</label>
                <input class="input" id="bdd-user-name" name="bdd-user-name" type="text" required>
            </div>
            <div class="form-group">
                <label class="control-label" for="bdd-user-pwd">Mot de passe</label>
                <input class="input" id="bdd-user-pwd" name="bdd-user-pwd" type="password" required>
            </div>
            <div class="form-group">
